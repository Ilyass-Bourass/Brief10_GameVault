    ...
    <header class="bg-orange-700 p-4 w-full z-50">
        <div class="flex justify-between items-center">
            <nav class="flex space-x-4">
                ...
                <a href="profil.php?user_id=<?php isset($_SESSION['user_id']) ? $_SESSION['user_id'] : '';?>"
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div
                ...
                <div class="p-6">
                    ...
                    <div class="flex justify-between items-center">
                    <form action="<?php echo isset($_SESSION['role']) && $_SESSION['role'] == 'USER' ? '../action/ajouterMabiliothetique.php' : ''; ?>" method="post">
